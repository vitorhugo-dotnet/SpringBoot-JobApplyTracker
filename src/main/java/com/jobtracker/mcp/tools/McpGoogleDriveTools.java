...
public class McpGoogleDriveTools {
    ...
    @Tool(description = """
            ...
            Requires BETA role.
            """)
    public BaseResumeContentResponse getBaseResumeContent(
            @ToolParam(description = "UUID of the base resume (not the filename)") String resumeId) {
    ...
    @Tool(description = """
            ...
            Requires BETA role.
            """)
    public GeneratedResumeContentResponse getGeneratedResumeContent(
            @ToolParam(description = "UUID of the job application") String applicationId) {
    ...
    public ResumePlaceholderDetectionResponse detectResumePlaceholders(
            @ToolParam(description = "UUID of the base resume (not the filename)") String baseResumeId) {
