...
class PasskeyLoginOptionsIT extends AbstractIntegrationTest {

    @Autowired
    private MockMvc mockMvc;

    @Test
    void passkeyLoginOptions_shouldStartDiscoverableAssertionWithoutEmail() throws Exception {
        mockMvc.perform(post("/api/v1/auth/passkey/login/options")
                ...
                .andExpect(jsonPath("$.publicKey.allowCredentials").doesNotExist());
    }
}
